# analysis/11-forest_diadiff.R
# Forest plot for DIA difference outcome:
#   Y = (O-DIA - C-DIA) - (K-DIA - C-DIA)
# Interpretation:
#   Y > 0 favors Ksens-DBP
#   Y < 0 favors Oscillo-DBP
#
# Inputs:
#   outputs/tables/subgroup_diff_dia_means.csv
#   outputs/tables/subgroup_diff_dia_contrasts.csv
...
means_path <- "outputs/tables/subgroup_diff_dia_means.csv"
cons_path  <- "outputs/tables/subgroup_diff_dia_contrasts.csv"
...
ggsave("outputs/figures/forest_DIA_diff_OC_minus_KC_subgroups.png", p, width = 16, height = 8, dpi = 300)
