# analysis/09-forest_dia.R
# Forest plot for DIA absolute-error difference outcome:
...
#
# Inputs:
#   outputs/tables/subgroup_absdiff_dia_means.csv
#   outputs/tables/subgroup_absdiff_dia_contrasts.csv
...
means_path <- "outputs/tables/subgroup_absdiff_dia_means.csv"
cons_path  <- "outputs/tables/subgroup_absdiff_dia_contrasts.csv"
