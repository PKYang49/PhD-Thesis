...
```{r fig.cap="Setup of the K-Sensor BP monitor. During cuff deflation, the K-Sensor continuously captures arterial wall vibrations associated with Korotkoff sounds. The signal is transmitted to a pretrained host-computer model to determine Ksens-BP.", fig.scap="Setup of the K-Sensor BP monitor."}
