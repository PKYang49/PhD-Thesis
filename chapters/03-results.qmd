...
```{r fig.cap="Study flow from enrollment to the final paired analytic dataset.", fig.scap="Study flow from enrollment to the final paired analytic dataset."}
...
```{r}
#| tbl-cap: "Agreement metrics between devices."
#| tbl-scap: "Agreement metrics between devices."
...
![Bland-Altman plots for systolic BP. Panel (A): Oscillo-BP versus auscultatory reference. Panel (B): Ksens-BP versus auscultatory reference.](../outputs/figures/3-2b.png){fig-scap="Bland-Altman plots for systolic BP."}

![](../outputs/figures/3-3a.png)

![Bland-Altman plots for diastolic BP. Panel (A): Oscillo-BP versus auscultatory reference. Panel (B): Ksens-BP versus auscultatory reference.](../outputs/figures/3-3b.png){fig-scap="Bland-Altman plots for diastolic BP."}
...
```{r fig.cap="Forest plot of subgroup analyses for systolic absolute differences.", fig.scap="Forest plot of subgroup analyses for systolic absolute differences.", out.width="100%"}
...
```{r fig.cap="Forest plot of subgroup analyses for diastolic absolute differences.", fig.scap="Forest plot of subgroup analyses for diastolic absolute differences.", out.width="100%"}
