...
::: {#fig-ba-sbp layout-ncol=1}
![](../outputs/figures/3-2a.png)

![](../outputs/figures/3-2b.png)

**Bland-Altman plots for systolic BP.** Panel (A): Oscillo-BP versus auscultatory reference. Panel (B): Ksens-BP versus auscultatory reference.
:::

::: {#fig-ba-dbp layout-ncol=1}
![](../outputs/figures/3-3a.png)

![](../outputs/figures/3-3b.png)

**Bland-Altman plots for diastolic BP.** Panel (A): Oscillo-BP versus auscultatory reference. Panel (B): Ksens-BP versus auscultatory reference.
:::
...
```{r fig.cap="\\textbf{Forest plot of subgroup analyses for systolic absolute differences.}", fig.scap="Forest plot of subgroup analyses for systolic absolute differences.", out.width="100%"}
...
```{r fig.cap="\\textbf{Forest plot of subgroup analyses for diastolic absolute differences.}", fig.scap="Forest plot of subgroup analyses for diastolic absolute differences.", out.width="100%"}
