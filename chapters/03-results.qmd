...
```{r fig.cap="Forest plot of subgroup analyses for systolic absolute differences.", fig.scap="Forest plot of subgroup analyses for systolic absolute differences.", out.width="110%"}
...
```{r fig.cap="Forest plot of subgroup analyses for diastolic absolute differences.", fig.scap="Forest plot of subgroup analyses for diastolic absolute differences.", out.width="110%"}
